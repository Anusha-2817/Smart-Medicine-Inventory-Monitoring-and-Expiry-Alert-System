    ...
    <div className="mx-auto max-w-3xl px-6 py-8">
      ...
      <div className="space-y-8">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          ...
          {profileMsg.text && (
            <div
              className={`mb-4 rounded-lg px-4 py-2 text-sm ${profileMsg.type === "success" ? "bg-mint-soft text-mint" : "bg-danger-soft text-danger"}`}
            >
              {profileMsg.text}
            </div>
          )}
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          ...
          {passwordMsg.text && (
            <div
              className={`mb-4 rounded-lg px-4 py-2 text-sm ${passwordMsg.type === "success" ? "bg-mint-soft text-mint" : "bg-danger-soft text-danger"}`}
            >
              {passwordMsg.text}
            </div>
          )}
